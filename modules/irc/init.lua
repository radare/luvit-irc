...
function IRC:_fin_connect(nick, host)
  self.sock:write("NICK "..nick.."\n")
  self.sock:write("USER "..nick.." "..nick.." "..host.." :"..nick.."\n")
  self:emit("connected")
end

function IRC:connect(host, port, nick, options)
